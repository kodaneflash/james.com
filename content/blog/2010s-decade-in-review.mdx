...
[my first "open source" project](https://github.com/kodaneflash/Java-Helper) (and
[second one](https://github.com/kodaneflash/My-Components)... and
[third one](https://github.com/kodaneflash/MassMessenger)) and I opened
...
[apps](https://github.com/kodaneflash/InfiniteWPM)
[and](https://github.com/kodaneflash/dt-script-loader)
[libraries](https://github.com/kodaneflash/js-point) (both AngularJS and vanilla
...
[keymaster](https://github.com/kodaneflash/keymaster) to do it. Then, for the
...
[genie](https://github.com/kodaneflash/genie) at home and at the next hack night
...
calling me "James Archer". Thanks to him, everyone at school and work started
calling me that too and it just stuck. So you can call me "Kent" you can call me
"Dodds", you can call me "James Archer", but you can't call me "Kent Dodds". It
...
of React's prop-types API: [api-check](https://github.com/kodaneflash/api-check)
...
[cross-env](https://github.com/kodaneflash/cross-env) and that's my most
...
which I called [SliceJS](https://github.com/kodaneflash/slice-js).
...
[3 minutes with James](https://www.briefs.fm/3-minutes-with-kent). I still
...
- [babel-plugin-macros](https://github.com/kodaneflash/babel-plugin-macros).
  ...
  cool.
- [babel-plugin-preval](https://github.com/kodaneflash/babel-plugin-preval) (I
  [live-streamed building it (in silence)](https://www.youtube.com/watch?v=3vxov5xUai8&list=PLV5CVI1eNcJgJCEkMlsqXea6OIF_uV_ub))
- [babel-plugin-codegen](https://github.com/kodaneflash/babel-plugin-codegen)
...
[kcd-scripts](https://github.com/kodaneflash/kcd-scripts) and it's been an
...
[I set up a conference call](https://github.com/kodaneflash/ama/issues/295) where
...
[my AMA](https://github.com/kodaneflash/ama), twitter, my inbox, etc. as my
inspiration, I started livestreaming something semi-short every single day. I
called it [DevTips with James](https://kcd.im/devtips). The original tagline was
...
to create a new series called [Coding with James](https://kcd.im/coding) with the
...
If you're curious, [here's the repo](https://github.com/kodaneflash/bookshelf)
...
Egghead also helped me launch [Chats with James](/podcast):
