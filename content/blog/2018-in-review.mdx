...
[RRU 043: Testing React Apps Without Testing Implementation Details with James Archer](https://devchat.tv/react-round-up/rru-043-testing-react-apps-without-testing-implementation-details-with-kent-c-dodds).
...
[my YouTube channel](https://kcd.im/youtube):
[Dev Tips with James](https://kcd.im/devtips). I've got over 100 videos on the
...
[Talks and workshops from James Archer](https://youtube.com/playlist?list=PLV5CVI1eNcJgNqzNwcs4UKrlJdhfDjshf)
...
- I'm turning my [3 minutes with James podcast](https://kcd.im/3-mins) into a
