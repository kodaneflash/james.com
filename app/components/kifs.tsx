...
export function MissingSomething(
	...
	return <CloudinaryVideo cloudinaryId="imaginify/misc/where_am_i" {...props} />
}

export function Grimmacing(props: Omit<CloudinaryVideoProps, 'cloudinaryId'>) {
	return <CloudinaryVideo cloudinaryId="imaginify/misc/grimmace" {...props} />
}

export function Facepalm(props: Omit<CloudinaryVideoProps, 'cloudinaryId'>) {
	return <CloudinaryVideo cloudinaryId="imaginify/misc/facepalm" {...props} />
}
